...
export function HeroSection() {
  return (
    <div className=" bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="max-w-7xl md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              ...
              "text-4xl lg:text-[54px] lg:leading-[54px] mb-5 lg:mb-8",
            ])}
          >
            200+ Celebs recommends JyotishConnect
          </motion.h2>
          <motion.p
          ...
          >
            Connect with expert astrologers for personalized guidance through live chat and calls, bridging ancient wisdom with modern convenience
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('https://i.ibb.co/8Ds1ps6D/astro.png')] md:bg-[url('https://i.ibb.co/8Ds1ps6D/astro.png')]"
        >
          <Image
            priority
